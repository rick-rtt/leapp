...
export class SessionCardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // Get profiles
    this.profiles = Repository.getInstance().getProfiles();
  ...
  getProfileName(profileId: string): string {
    const profileName = Repository.getInstance().getProfileName(profileId);
  ...
  async changeProfile() {
    if (this.selectedProfile) {
      ...
      if(!Repository.getInstance().getProfileName(this.selectedProfile.id)) {
        Repository.getInstance().addProfile(this.selectedProfile);
      }
