...
describe('sessionFactory', () => {
  it('getSessionService', function () {
    ...
    const sessionFactory = new SessionFactory(awsIamUserService, awsIamRoleFederatedService, awsIamRoleChainedService,
      awsSsoRoleService, azureService)
  ...
  it('createSession', async function () {
    ...
    const sessionFactory = new SessionFactory(null, null,
      null, null, null)
